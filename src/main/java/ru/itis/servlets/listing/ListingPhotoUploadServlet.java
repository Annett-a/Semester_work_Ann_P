...
@MultipartConfig( maxFileSize = 5 * 1024 * 1024, maxRequestSize = 30 * 1024 * 1024 ) // 5MB/файл
public class ListingPhotoUploadServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
            throws IOException, ServletException {   // ← добавили ServletException
        ...
        // если проект на Java < 16, см. пункт 2
